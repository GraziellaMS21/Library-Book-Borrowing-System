        ...
        <div class="section manage_users ">
            ...
            <div class="tabs flex border-b border-gray-200 mb-6">
                ...
                <a href="?tab=approved" class="tab-btn <?= $current_tab == 'approved' ? 'active' : '' ?>">Approved
                    Request</a>
                <a href="?tab=borrowed" class="tab-btn <?= $current_tab == 'borrowed' ? 'active' : '' ?>">Currently
                    Borrowed</a>
                                ...
                                <?php if ($current_tab == 'pending'): ?>
                                    ...
                                    <td class="action text-center">
                                        ...
                                        <button
                                            ...
                                            data-target="rejectRequestModal" data-id="<?= $borrowID ?>"
                                ...
                                <?php elseif ($current_tab == 'approved'): ?>
                                    ...
                                    <td class="action text-center">
                                        ...
                                        <button
                                            ...
                                            data-target="cancelRequestModal" data-id="<?= $borrowID ?>"
                                            data-title="<?= $bookTitle ?>">
                                            Cancel
                                        </button>
