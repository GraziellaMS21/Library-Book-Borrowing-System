...
<body class="h-screen w-screen flex">
                                ...
                                foreach ($borrow_details as $detail) {
                                    ...
                                    <tr>
                                        ...
                                        <?php elseif ($current_tab == 'borrowed'): ?>
                                            ...
                                            <td
                                                class="<?= ($detail["calculated_fine"] > 0 && $detail["fine_status"] === 'Unpaid') ? 'text-red-700' : 'text-gray-700' ?>">
                                            ...
                                            <td class="action text-center">
                                                <?php if ($detail["calculated_fine"] > 0) { ?>
                                                    ...
                                                    <a class="actionBtn bg-yellow-600 hover:bg-yellow-700 text-sm inline-block mb-1"
                                                        href="borrowDetailsSection.php?modal=block&id=<?= $borrowID ?>&tab=<?= $current_tab ?>">Block
                                                        User</a>
                                                <?php } else { ?>
        ...
        <div class="modal-content">
            ...
            <form id="editBorrowDetailForm"
                ...
                <div>
                    ...
                    <p class="text-lg"><?= htmlspecialchars($modal_borrow_details['book_title'] ?? 'N/A') ?>
                    </p>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div class="input">
                        <label for="no_of_copies">No. of Copies<span>*</span> : </label>
                        <input type="number" class="input-field !w-5/6" name="no_of_copies" id="edit_no_of_copies"
                    ...
                    <div class="input">
                        ...
                        <input type="date" class="input-field !w-5/6" name="request_date" id="edit_request_date"
                    ...
                    <div class="input">
                        ...
                        <input type="date" class="input-field !w-5/6" name="pickup_date" id="edit_pickup_date"
                    ...
                    <div class="input">
                        ...
                        <p class="text-sm text-gray-500 italic">Fine recalculation is automatic when fine is set to
                            0.00. <button id="fineReset" type="button" class="font-bold underline">Reset Fine</button>
                        </p>
                    ...
                    <div class="input">
                        ...
                        <input type="date" class="input-field !w-5/6" name="return_date" id="edit_return_date"
                    ...
                    <div class="input">
                        ...
                        <select name="borrow_request_status" id="edit_borrow_request_status" class="input-field !w-5/6">
                    ...
                    <div class="input">
                        ...
                        <select name="borrow_status" id="edit_borrow_status" class="input-field !w-5/6">
                            <option value="">---Select Status---</option>
                            <?php
                    ...
                    <div class="input">
                        ...
                        <select name="returned_condition" id="edit_returned_condition" class="input-field !w-5/6">
                    ...
                    <div class="input">
                        ...
                        <select name="fine_reason" id="edit_fine_reason" class="input-field !w-5/6">
                    ...
                    <div class="input">
                        ...
                        <select name="fine_status" id="edit_fine_status" class="input-field !w-5/6">
                            <option value="">---Select Status---</option>
                            <?php
    ...
    <div id="deleteConfirmModal" class="modal delete-modal <?= $open_modal == 'deleteConfirmModal' ? 'open' : '' ?>">
        <div class="modal-content max-w-sm">
            ...
            <div class="cancelConfirmBtns">
                ...
                <a href="../../../app/controllers/bookController.php?action=delete&id=<?= $modal_borrow_details['borrowID'] ?>"
    ...
    <div id="paidConfirmModal" class="modal delete-modal <?= $open_modal == 'paidConfirmModal' ? 'open' : '' ?>">
        <div class="modal-content max-w-lg">
            ...
            <form action="../../../app/controllers/borrowDetailsController.php?action=paid&id=<?= $borrow_id ?? '' ?>"
                ...
                <p class="mb-4 text-gray-700">
                    You are marking the fine as <strong>Paid</strong> and the book as <strong>Returned</strong> for:
                    <span class="font-semibold text-red-800"><?= $modal_borrow_details['book_title'] ?? 'N/A' ?></span>.
                </p>
                <label class="block font-semibold mb-1" for="returned_condition">
                    Returned Condition<span>*</span> :
                ...
                <div class="w-full grid grid-cols-[auto,1fr] gap-y-2 my-4 p-3 bg-gray-100 rounded-lg">
                    <p class="font-semibold col-span-2 text-md text-blue-800 border-b pb-1">
                        Loan and Fine Details
                    </p>
                ...
                <div class="cancelConfirmBtns">
                    ...
                    <input type="submit" value="Confirm Paid"
                        class="font-bold cursor-pointer mt-6 border-none rounded-lg !bg-green-600 btnPaid text-white p-3 w-full hover:bg-green-800">
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="blockUserModal" class="modal delete-modal <?= $open_modal == 'blockUserModal' ? 'open' : '' ?>">
        <div class="modal-content max-w-sm">
            <span class="close close-times" data-modal="blockUserModal" data-tab="<?= $current_tab ?>">&times;</span>
            <h2 class="text-xl font-bold mb-4 text-orange-700">Confirm User Block</h2>
            <p class="mb-6 text-gray-700">
                Are you sure you want to <strong>Block</strong>
                <span
                    class="font-bold italic text-red-600"><?= htmlspecialchars($modal_borrow_details['fName'] ?? 'N/A') . ' ' . htmlspecialchars($modal_borrow_details['lName'] ?? '') ?></span>
            ...
            <div class="cancelConfirmBtns">
                ...
                <a href="../../../app/controllers/borrowDetailsController.php?action=blockUser&id=<?= $borrow_id ?? '' ?>"
                    class="!bg-yellow-600 text-white px-4 py-2 rounded-lg font-semibold btnBlock cursor-pointer">
                    Confirm Block
                </a>
            </div>
        </div>
        ...
        <div class="modal-content max-w-lg">
            ...
            <div class="flex justify-end mt-6">
                <button type="button"
                    ...
                    data-modal="viewFullDetailsModal" data-tab="<?= $current_tab ?>">
                    Close
                </button>
            </div>
        </div>
...
<script>
    document.getElementById("fineReset").addEventListener("click", () => {
