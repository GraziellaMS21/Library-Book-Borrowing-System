    ...
    <div class="w-full h-screen flex flex-col">
        ...
        <main class="overflow-y-auto relative">
            <div class="tabs bg-white sticky top-0 z-2 flex text-center shadow-lg border-b border-gray-200 mb-6"
                ...
                <a href="#borrowing">Borrowing Reports</a>
                <a href="#fines">Fine and Payment Reports</a>
                <a href="#user">User Reports</a>
                <a href="#inventory">Book Inventory Reports</a>
                <a href="#overdue">Overdue and Late Return Reports</a>
            </div>
            <div class="container">
                <div class="px-8 manage_users h-full">
                    ...
                    <div id="borrowing">
                        <h2 class="font-extrabold text-3xl pl-8 pt-4 text-red-900">BORROWING REPORTS</h2>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                            ...
                            <div class="report-chart-container">
                                <h2 class="text-xl font-bold text-red-800 mb-4">2. Top 5 Categories (All Time)
                                </h2>
                                <canvas id="borrowTrendCategoryChart"></canvas>
                            </div>
                            <div class="report-chart-container">
                                <h2 class="text-xl font-bold text-red-800 mb-4">3. Top 5 Most Borrowed Books
                                </h2>
                    ...
                    <div id="fines">
                        <h2 class="font-extrabold text-3xl pl-8 pt-4 text-red-900">FINE AND PAYMENT REPORTS</h2>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                            <div class="report-chart-container">
                            ...
                            <div class="report-chart-container">
                                <h2 class="text-xl font-bold text-red-800 mb-4">2. Top 5 Users with Unpaid Fines
                                </h2>
                    ...
                    <div id="user">
                        <h2 class="font-extrabold text-3xl pl-8 pt-4 text-red-900">USER REPORTS</h2>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                            <div class="report-chart-container">
                                <h2 class="text-xl font-bold text-red-800 mb-4">1. Top 5 Most Active Borrowers
                                </h2>
                    ...
                    <div id="inventory">
                        <h2 class="font-extrabold text-3xl pl-8 pt-4 text-red-900">BOOK INVENTORY REPORTS</h2>
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                            <div class="report-chart-container">
                            ...
                            <div class="report-chart-container lg:col-span-2">
                                <h2 class="text-xl font-bold text-red-800 mb-4">3. Average Borrow Duration by
                                    Category</h2>
                    ...
                    <div id="overdue">
                        <h2 class="font-extrabold text-3xl pl-8 pt-4 text-red-900">OVERDUE AND LATE RETURN REPORTS</h2>
                        <div class="view mt-4">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="report-chart-container">
                                    <h2 class="text-xl font-bold text-red-800 mb-4">1. Overdue Books Summary
                                    </h2>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <?php if (empty($overdue_books_summary)): ?>
                                                        <tr>
                                                            <td colspan="5" class="text-center py-4">No overdue books
                                                                found.</td>
                                                        </tr>
                                                <?php else: ?>
