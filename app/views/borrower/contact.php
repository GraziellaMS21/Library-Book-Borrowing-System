    ...
    <main class="relative z-20 px-4 sm:px-6 lg:px-8 py-10 pb-20">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="contact-card shadow-2xl flex flex-col md:flex-row overflow-hidden rounded-xl">
                ...
                <div class="info-section md:w-5/12 lg:w-4/12 relative text-white p-10 lg:p-12 flex flex-col justify-between">
                    <div class="pattern-overlay"></div>
                    
                    <div class="relative z-10">
                        <h2 class="font-playfair text-3xl mb-2 text-gold">Contact Information</h2>
                        <p class="text-red-100 text-sm mb-10 opacity-80">We'd love to hear from you. Reach out to us using any of the methods below.</p>
                        ...
                        <div class="space-y-8"> 
                            <div class="flex items-start group">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-100 text-sm leading-relaxed">Normal Road, Baliwasan,<br>Zamboanga City, Philippines</p>
                                </div>
                            </div>
                ...
                <div class="form-section md:w-7/12 lg:w-8/12 bg-white p-10 lg:p-12 relative">
                    <div class="max-w-lg mx-auto">
                        ...
                        <p class="text-gray-500 mb-8 text-sm">Have a question about borrowing? Fill out the form below.</p>
                        ...
                        <form action="../../../app/controllers/emailController.php" method="POST" class="space-y-6">
                            ...
                            <div class="input-group relative">
                                <input type="text" id="subject" name="subject" class="input-field peer" placeholder=" " required>
                                <label for="subject" class="floating-label">Subject</label>
                            </div>

                            <div class="input-group relative">
                                <textarea id="message" name="message" class="input-field peer h-32 pt-3 resize-none" placeholder=" " required></textarea>
