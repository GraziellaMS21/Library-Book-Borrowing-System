                                                ...
                                                <tr class="border-b hover:bg-gray-50" data-borrow-id="<?= $book['borrowID'] ?>">
                                                    ...
                                                    <?php elseif ($active_tab == 'returned'): ?>
                                                            ...
                                                            <?php else: ?>
                                                                    ...
                                                                    <td class="py-4 px-4 text-sm text-gray-600 max-w-xs whitespace-normal">
                                                                        <?= htmlspecialchars($book['status_reason'] ?? 'No reason provided') ?>
                                                                    </td>
                                                            <?php endif; ?>
                                                            <td class="py-4 px-4">
                                                                <button
